...
Jay Wilbur (Bizz Guy): choose any one character or any pair with the COMPANIONS selector. Maximum two companions. Hold J to aim Jay's camp circle and release to place him; independent 10-second cooldown. K and L still control Romero and Carmack. F7 releases every active companion. The HUD, title scene, and tally follow the selected team. Jay uses the supplied three eye-direction portraits in the HUD and the center portrait on the tally. CHAT in the menu toggles occasional original fictional character banter; it does not add voice recordings.
