...
Load the updated main mod first, then Himiko_Companion_Addon.pk3. This existing filename now contains Himiko, Tina, Frier, Tuin, Kumi and Ernie. Open ESC > Extras or Options > Extra Companions.
...
Karin and Esther are temporarily unavailable in the roster. Their source sheets, portraits, extracted sprites and actor definitions are retained for later restoration. Saved teams filter them out while keeping any other selected companion.
